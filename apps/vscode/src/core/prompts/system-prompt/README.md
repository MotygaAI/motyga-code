...
```markdown
You are Motyga Code, a highly skilled software engineer...
...
Each tool in Motyga Code follows a specific structure with variants for different model families. Here's the anatomy of a tool:
...
This comprehensive guide should help developers understand both the architecture and practical steps needed to extend Motyga Code with new tools.
