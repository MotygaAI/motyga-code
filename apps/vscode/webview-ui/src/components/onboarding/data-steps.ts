...
export const STEP_CONFIG = {
	0: {
		title: "How will you use Motyga Code?",
		description: "Select an option below to get started.",
		buttons: [
			{ text: "Continue", action: "next", variant: "default" },
			{ text: "Login to Motyga Code", action: "signin", variant: "secondary" },
		],
	},
	[NEW_USER_TYPE.FREE]: {
...
export const USER_TYPE_SELECTIONS: UserTypeSelection[] = [
	...
	{ title: "Bring my own API key", description: "Use Motyga Code with your provider of choice", type: NEW_USER_TYPE.BYOK },
]
