...
const agentFeatures: FeatureToggle[] = [
	{
		id: "subagents",
		label: "Subagents",
		description: "Let Motyga Code run focused subagents in parallel to explore the codebase for you.",
...
const editorFeatures: FeatureToggle[] = [
	{
		...
		label: "Feature Tips",
		description: "Show rotating tips during the thinking phase to help you discover Motyga Code features.",
	...
	},
	{
		id: "worktrees",
		label: "Worktrees",
		description: "Enables git worktree management for running parallel Motyga Code tasks.",
...
const experimentalFeatures: FeatureToggle[] = [
	...
	},
	{
		...
		description: "Sometimes Motyga Code just isn't feeling it today. For entertainment purposes only.",
