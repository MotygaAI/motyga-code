...
describe("ErrorRow", () => {
	...
	it("renders clineignore error", () => {
		...
		expect(screen.getByText(/Motyga Code tried to access/)).toBeInTheDocument()
	...
	describe("API error handling", () => {
		...
		it("renders friendly logged-out message and sign in button when user is not signed in", async () => {
			...
			expect(screen.getByText("Sign in to Motyga Code")).toBeInTheDocument()
		})
		...
		it("falls back to regular error message when ClineError.parse returns null", async () => {
			...
			// When ClineError.parse returns null, we display the raw error message for non-Motyga Code providers
