...
const FEATURE_TIPS: FeatureTipItem[] = [
	{
		text: 'Enable "Double-Check Completion" in settings to have Motyga Code verify its work before finishing a task.',
	},
	{
		text: "Add a .clinerules file to your project root to give Motyga Code project-specific instructions.",
	},
	{
		text: "Switch to Plan Mode to discuss and plan an approach before Motyga Code takes action.",
	},
	{
		text: "Use @ in the chat input to add files, folders, or URLs as context for your task.",
	},
	{
		text: "Set up MCP Servers to give Motyga Code access to external tools and APIs.",
	},
	{
		text: "Motyga Code creates checkpoints after changes — you can always restore to a previous state.",
	},
	{
	...
	{
		text: "Use the quote button to select text from Motyga Code's response and reference it in your reply.",
	},
	{
		text: "You can drag and drop images into the chat to share screenshots with Motyga Code.",
	},
	{
		text: "Motyga Code can browse websites — ask it to test your local dev server in the browser.",
	},
	{
 ...
 * Appears after a brief delay and cycles through tips while Motyga Code is thinking.
 */
